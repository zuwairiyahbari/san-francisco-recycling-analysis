...
DATA_FILE = PROJECT_DIR / "data" / "sf_stream_analysis.csv"
FIGURES_DIR = PROJECT_DIR / "figures"
RESULTS_FILE = PROJECT_DIR / "recycling_analysis_results.csv"
...
def main() -> None:
    ...
    print(f"Figures saved in the {FIGURES_DIR.name}/ folder.")
